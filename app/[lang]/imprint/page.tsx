      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert max-w-none">
          <section className="mb-10">
            ...
            <div className="bg-card border border-border/30 rounded-xl p-6">
              <p className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">KreateRevo UG (haftungsbeschränkt)</strong>
                <br />
                Residenzstraße 133A
                <br />
                13409 Berlin
          ...
          <section className="mb-10">
            ...
            <div className="bg-card border border-border/30 rounded-xl p-6">
              <p className="text-muted-foreground leading-relaxed">
                {isGerman ? 'Telefon:' : 'Phone:'} +49 1590 6702779
                <br />
          ...
          <section className="mb-10">
            <h2 className="font-display font-semibold text-2xl mb-4">
              {isGerman ? 'Registereintrag' : 'Commercial Register'}
            </h2>
            <div className="bg-card border border-border/30 rounded-xl p-6">
              <p className="text-muted-foreground leading-relaxed">
                ...
                <br />
                <strong className="text-foreground">
                  {isGerman ? 'Handelsregisternummer:' : 'Commercial Register Number:'}
                </strong>{' '}
                HRB 283656
              </p>
            </div>
