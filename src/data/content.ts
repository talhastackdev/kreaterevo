import type { Service, CaseStudy, Testimonial, FAQ, ProcessStep, PricingPlan } from '@/types';
...
export const services: Service[] = [
  {
    ...
    fullDescription: 'We design, build, and operate cloud infrastructure that scales with your business. From initial architecture to cost optimization, we ensure your cloud environment is secure, compliant, and performant.',
    whoItsFor: [
  ...
  },
  {
    ...
    fullDescription: 'Bring modern DevOps automation to your on-premise infrastructure. We help you implement CI/CD, containerization, and infrastructure as code without sacrificing control or security.',
    whoItsFor: [
  ...
  },
  {
    ...
    fullDescription: 'Automate your software delivery from commit to production. We build CI/CD pipelines that enable frequent, reliable releases with built-in quality gates and security checks.',
    whoItsFor: [
  ...
  },
  {
    ...
    fullDescription: 'Implement Site Reliability Engineering practices that keep your systems running. From comprehensive monitoring to incident response, we help you achieve reliability at scale.',
    whoItsFor: [
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    industry: 'Retail',
    challenge: 'Legacy on-premise infrastructure could not handle seasonal traffic spikes, causing frequent outages during peak sales periods. The company needed to migrate to cloud while maintaining PCI DSS compliance.',
    approach: [
  ...
  },
  {
    ...
    challenge: 'Manual deployment processes were error-prone and slow, releasing only once per month. The team needed to accelerate delivery while maintaining SOC 2 compliance and audit trails.',
    approach: [
  ...
  },
  {
    ...
    industry: 'Software',
    challenge: 'The platform experienced frequent incidents with slow mean time to recovery (MTTR). The team lacked visibility into system behavior and was overwhelmed by alert noise.',
    approach: [
...
export const faqs: FAQ[] = [
  {
    ...
    answer: 'Yes, we specialize in both. Many of our clients have hybrid setups or are in various stages of cloud migration. We design solutions that work with your current infrastructure while preparing you for future growth.'
  },
  {
    question: 'How long does a typical migration take?',
    answer: 'Timeline depends on scope and complexity. A pilot migration might take 2-4 weeks, while a full enterprise migration can span 3-6 months. We always start with a thorough assessment to provide accurate estimates.'
  },
  {
    question: 'Do you provide 24/7 support?',
    answer: 'Our Growth and Enterprise plans include on-call support with defined SLAs. We can also establish 24/7 coverage for critical systems with escalation procedures tailored to your needs.'
  },
  {
    question: 'What does "done" look like?',
    answer: 'We define success metrics upfront—whether that is deployment frequency, cost reduction, uptime targets, or mean time to recovery. You receive full documentation, runbooks, and knowledge transfer to ensure your team can operate independently.'
  },
  {
    question: 'Can you work within our compliance requirements?',
    answer: 'Absolutely. We have experience with SOC 2, ISO 27001, GDPR, HIPAA, and PCI DSS. We build compliance into the infrastructure from day one, not as an afterthought.'
  },
  {
    question: 'How do we get started?',
    answer: 'Book a free consultation through our website. We will discuss your current challenges, goals, and constraints. Within a week, you will receive a detailed proposal with scope, timeline, and pricing.'
  }
];
...
export const processSteps: ProcessStep[] = [
  {
    number: '01',
    title: 'Discover',
    description: 'We map your systems, identify risks, and understand your constraints. This includes infrastructure audit, stakeholder interviews, and goal alignment.'
  },
  {
    number: '02',
    title: 'Design',
    description: 'We create architecture and runbooks tailored to your stack. Every design decision is documented and reviewed with your team before implementation.'
  },
  {
    number: '03',
    title: 'Build',
    description: 'We implement infrastructure as code, pipelines, and guardrails. All work is version-controlled, tested, and deployed through automated processes.'
  },
  {
    number: '04',
    title: 'Operate',
    description: 'We monitor, optimize, and hand off cleanly. Knowledge transfer ensures your team can maintain and extend what we have built together.'
  }
];
...
export const whyChooseUs = [
  {
    title: 'Speed',
    description: 'We deliver working infrastructure in weeks, not months. Our iterative approach means you see value from day one.'
  },
  {
    title: 'Reliability',
    description: 'We build systems that stay up. Our designs prioritize fault tolerance, automated recovery, and clear escalation paths.'
  },
  {
    title: 'Transparency',
    description: 'No black boxes. Every decision is documented, every change is tracked, and you maintain full ownership of your infrastructure.'
  },
  {
    title: 'Security',
    description: 'Security is built in, not bolted on. From least-privilege access to encryption at rest and in transit, we follow industry best practices.'
  },
  {
    title: 'Documentation',
    description: 'We write everything down. Runbooks, architecture decisions, and operational procedures are part of every deliverable.'
  }
];
...
export const securityFeatures = [
  {
    ...
    description: 'Least privilege, MFA, SSO, and audit-ready access logs. Every access request is logged and reviewable.'
  },
  {
    title: 'Encryption',
  ...
  {
    title: 'Compliance',
    description: 'SOC 2, ISO 27001, GDPR-ready controls. Regular audits and continuous compliance monitoring.'
  }
];
