        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            ...
            <p className="text-muted-foreground">
              {isGerman ? 'Zuletzt aktualisiert: ' : 'Last updated: '}{new Date().toLocaleDateString(isGerman ? 'de-DE' : 'en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}
            </p>
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-10">
              <h2 className="font-display font-semibold text-2xl mb-4">{isGerman ? '1. Einleitung' : '1. Introduction'}</h2>
            ...
            <section className="mb-10">
              <h2 className="font-display font-semibold text-2xl mb-4">{isGerman ? '2. Informationen, Die Wir Sammeln' : '2. Information We Collect'}</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {isGerman 
              ...
              <h3 className="font-medium text-lg mb-3">{isGerman ? '2.1 Persönliche Daten' : '2.1 Personal Data'}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {isGerman 
            ...
            <section className="mb-10">
              <h2 className="font-display font-semibold text-2xl mb-4">{isGerman ? '3. DSGVO-Konformität (für EU-Bürger)' : '3. GDPR Compliance (for EU Residents)'}</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {isGerman 
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li><strong>{isGerman ? 'Recht auf Auskunft:' : 'Right to Access:'}</strong> {isGerman ? 'Sie haben das Recht, Kopien Ihrer persönlichen Daten anzufordern.' : 'You have the right to request copies of your personal data.'}</li>
                <li><strong>{isGerman ? 'Recht auf Berichtigung:' : 'Right to Rectification:'}</strong> {isGerman ? 'Sie haben das Recht, die Berichtigung von Informationen zu verlangen, die Sie für ungenau halten.' : 'You have the right to request that we correct any information you believe is inaccurate.'}</li>
                <li><strong>{isGerman ? 'Recht auf Löschung:' : 'Right to Erasure:'}</strong> {isGerman ? 'Sie haben das Recht, die Löschung Ihrer persönlichen Daten zu verlangen.' : 'You have the right to request that we erase your personal data.'}</li>
              </ul>
            </section>

            <section className="mb-10">
              <h2 className="font-display font-semibold text-2xl mb-4">{isGerman ? '8. Kontaktieren Sie Uns' : '8. Contact Us'}</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {isGerman 
