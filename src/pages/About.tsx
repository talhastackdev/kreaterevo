  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <span className="section-label mb-4 block">{t('nav.about')}</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              <ModuleCard className="aspect-square flex items-center justify-center bg-gradient-to-br from-primary/20 to-primary/5" showPort={false}>
                <div className="text-center">
                  ...
                  <div className="text-sm text-muted-foreground">{language === 'de' ? 'Jahre Erfahrung' : 'Years Experience'}</div>
                </div>
              </ModuleCard>
              <ModuleCard className="aspect-square flex items-center justify-center bg-gradient-to-br from-secondary to-secondary/50" showPort={false}>
                <div className="text-center">
                  ...
                  <div className="text-sm text-muted-foreground">{language === 'de' ? 'Ansässig in Deutschland' : 'Based in Germany'}</div>
                </div>
              </ModuleCard>
              <ModuleCard className="aspect-square flex items-center justify-center bg-gradient-to-br from-secondary to-secondary/50" showPort={false}>
                <div className="text-center">
                  <div className="font-display font-bold text-4xl text-primary mb-2">24/7</div>
                  <div className="text-sm text-muted-foreground">{language === 'de' ? 'Support Verfügbar' : 'Support Available'}</div>
                </div>
              </ModuleCard>
              <ModuleCard className="aspect-square flex items-center justify-center bg-gradient-to-br from-primary/20 to-primary/5" showPort={false}>
                <div className="text-center">
                  <div className="font-display font-bold text-4xl text-primary mb-2">IaC</div>
                  <div className="text-sm text-muted-foreground">{language === 'de' ? 'Infrastructure as Code' : 'Infrastructure as Code'}</div>
                </div>
              </ModuleCard>
            </div>
          </div>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="section-label mb-4 block">{t('about.security.title')}</span>
            <h2 className="font-display font-bold text-display-2 mb-4">
      ...
      <section className="py-20 lg:py-32 bg-charcoal-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="section-label mb-4 block">{t('about.leadership.label')}</span>
            <h2 className="font-display font-bold text-display-2 mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            <ModuleCard className="p-8 lg:p-12" showPort={false}>
              <div className="grid md:grid-cols-[200px_1fr] gap-8 items-start">
                ...
                {/* Profile Content */}
                <div>
                  <h3 className="font-display font-semibold text-2xl lg:text-3xl mb-1">{t('about.leadership.name')}</h3>
                  <p className="text-primary font-medium mb-6">{t('about.leadership.role')}</p>
                  
                  <div className="space-y-4 text-muted-foreground">
                    <p>{t('about.leadership.p1')}</p>
                    <p>{t('about.leadership.p2')}</p>
                    <p>{t('about.leadership.p3')}</p>
                  </div>
